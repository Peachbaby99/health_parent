...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "tf50ZWzu15oeXYNSHquPpp9kIUOftV9yG_kk614w";
    private static final String SECRETKEY = "9vvgblO2vT4Ci1DwBjTiAWUzBerenD9fZ3hrXshs";
    private static final String BUCKET = "peach666";
    public static final String DOMAIN= "http://q0wbm609n.bkt.clouddn.com";
